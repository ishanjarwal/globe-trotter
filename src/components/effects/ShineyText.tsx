...
export function AnimatedShinyTextDemo() {
  return (
    <div className="">
      ...
      >
        <AnimatedShinyText className="inline-flex items-center justify-center gap-x-2 px-4 py-1 transition ease-out hover:text-neutral-600 hover:duration-300 hover:dark:text-neutral-400">
